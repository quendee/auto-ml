...
static void __pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_col_to_bins(__Pyx_memviewslice, __Pyx_memviewslice, unsigned char const , __Pyx_memviewslice); /*proto*/
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C__const__(PyList_GET_ITEM(__pyx_v_binning_thresholds, __pyx_v_feature_idx), 0); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 46, __pyx_L1_error)
...
__pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_col_to_bins(__pyx_t_4, __pyx_t_5, __pyx_v_missing_values_bin_idx, __pyx_t_6);
...
static void __pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_col_to_bins(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_binning_thresholds, unsigned char const __pyx_v_missing_values_bin_idx, __Pyx_memviewslice __pyx_v_binned) {
  int __pyx_v_i;
  int __pyx_v_left;
  int __pyx_v_right;
  int __pyx_v_middle;
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        if (unlikely(!__pyx_v_data.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("data"); __PYX_ERR(0, 62, __pyx_L4_error) }
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("sklearn.ensemble._hist_gradient_boosting._binning._map_col_to_bins", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
 ...
 */
  ...
  __pyx_codeobj__22 = (PyObject*)__Pyx_PyCode_New(4, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_map_to_bins, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__22)) __PYX_ERR(0, 22, __pyx_L1_error)
